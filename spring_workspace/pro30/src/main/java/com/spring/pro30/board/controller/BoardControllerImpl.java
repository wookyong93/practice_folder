...
//	}
	...
	public ModelAndView viewArticle(@RequestParam("articleNO") int articleNO,
	  ...
	  String imageFileName= upload1(multipartRequest); HttpSession session =
	  multipartRequest.getSession(); MemberVO memberVO = (MemberVO)
	  session.getAttribute("member"); String id = memberVO.getId();
  ...
  public ResponseEntity  addNewArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse response) throws Exception {
	...
	//한개 이미지 업로드하기
	  ...
	  private String upload1(MultipartHttpServletRequest multipartRequest) throws
	  ...
	  File(ARTICLE_IMAGE_REPO +"\\"+ fileName); if(mFile.getSize()!=0){ //File NullCheck 
