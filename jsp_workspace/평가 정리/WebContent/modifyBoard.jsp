...
<body>
	...
	<form name="frm" action="boardMain.jsp" method="post">
		<table>
			<tr>
				<th colspan ="2"><h3>수정</h3></th>
			</tr>
			<tr>
				<th width=10%>제목</th>
				<td><input type="text" size="40" name="title" value=<%=bDto.getTitle() %>/></td>
			</tr>
			<tr>
				<th>내용</th>
				<td><textarea rows="10" cols="40" name="content"><%=bDto.getContent() %></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
		...
		<input type="hidden" name="articleNo" value="<%=bDto.getArticleNO() %>"/>
	</form>
</html>